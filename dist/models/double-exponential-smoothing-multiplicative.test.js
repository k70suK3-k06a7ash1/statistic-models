...
test("doubleExponentialSmoothingMultiplicative should handle array with single element", function () {
    var data = [10];
    var alpha = 0.5;
    var beta = 0.5;
    var result = doubleExponentialSmoothingMultiplicative(data, alpha, beta);
...
test("doubleExponentialSmoothingMultiplicative should calculate level, trend and smoothed data correctly", function () {
